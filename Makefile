...
submit:
	../cli-tools-1.6.0/experiment-cli submit -n trackBalancing -d 5 \
		-l grenoble,m3,50+58,projects/common/03oos_openwsn.elf \
		-l grenoble,m3,68,projects/common/03oos_openwsn_dagroot.elf 
rsync:
